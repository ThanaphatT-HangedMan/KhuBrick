...
{
    public class AnimatedTexture           //อันนี้ของเฮงๆ ของก๊อปอะ เข้าใจบ่
    {
       ...
       private int startframe;
        ...
        public void Load(ContentManager content, Texture2D asset, int frameCount, int frameRow, int framesPerSec, int startRow,int type)
        {
            framecount = frameCount;
            framerow = frameRow;
            startframe = 0;
